...
function Sidebar(props) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar
        position="fixed"
        sx={{  width: { sm: `calc(100% - ${drawerWidth}px)` },  ml: { sm: `${drawerWidth}px` }, bgcolor:'#90caf9' }}  >
{/* <Box >
  ...
  <Typography sx={{display: {xs:"none" , md:"flex" }}}>Welcome user</Typography>
        ...
        <Toolbar sx={{display:"flex", justifyContent:"space-between"}}  >
          ...
          <Stack direction={'row'}>
              ...
              <Typography sx={{display: {xs:"none" , md:"flex" } , alignItems:'center', }} >username</Typography>
              <IconButton
                size="large"
      ...
      <Box
        component="main"
        sx={{ flexGrow: 1, p: 3, width: { sm: `calc(100% - ${drawerWidth}px)` } , bgcolor:'#e3f2fd' }}
      >
      <Toolbar />
